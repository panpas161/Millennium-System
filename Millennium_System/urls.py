...
urlpatterns = [
    ...
    path('oaed/departments/schedule/view/<pk>',oaedsubsidyviews.viewScheduleDepartmentView,name="view_schedule_oaed_susidy_department"),
    path('oaed/departments/schedule/create/<pk>',oaedsubsidyviews.createScheduleDepartmentView,name="create_schedule_oaed_susidy_department"),
